...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::NRN).toInt();
    ...
    fAutoRedeemNeuron = settings.value("fAutoRedeemNeuron", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemNeuron:
            return fAutoRedeemNeuron;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemNeuron: return "AutoRedeemNeuron";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::NRN).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemNeuron: {
            fAutoRedeemNeuron = value.toBool();
            settings.setValue("fAutoRedeemNeuron", fAutoRedeemNeuron);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemNeuron() { return fAutoRedeemNeuron; }
